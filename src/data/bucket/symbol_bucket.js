...
class SymbolBucket implements Bucket {
    ...
    addSymbolInstance(anchorX: number, anchorY: number, horizontalPlacedTextSymbolIndex: number,
                      verticalPlacedTextSymbolIndex: number, key: number, textBoxStartIndex: number,
                      textBoxEndIndex: number, iconBoxStartIndex: number, iconBoxEndIndex: number,
                      featureIndex: number, numGlyphVertices: number, numVerticalGlyphVertices: number,
                      numIconVertices: number) {
        this.symbolInstances.emplaceBack(anchorX, anchorY, horizontalPlacedTextSymbolIndex,
                                         verticalPlacedTextSymbolIndex, key, textBoxStartIndex,
                                         textBoxEndIndex, iconBoxStartIndex, iconBoxEndIndex, featureIndex,
                                         numGlyphVertices, numVerticalGlyphVertices, numIconVertices);
    }
