...
class SymbolInstanceStruct extends Struct {
    ...
    get crossTileID() { return this.crossTileIDs[this.index]; }
    set crossTileID(x) { this.crossTileIDs[this.index] = x; }
}

SymbolInstanceStruct.prototype.size = 26;
...
export class SymbolInstanceArray extends StructArrayLayout4i9ul26 {
    ...
    get(index: number): SymbolInstanceStruct {
        assert(!this.isTransferred);
        return new SymbolInstanceStruct(this, index, this.crossTileIDs);
    }
}
